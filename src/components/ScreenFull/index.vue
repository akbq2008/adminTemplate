<!--
 * @Author: wang_yechao
 * @Date: 2020-02-29 22:57:50
 -->
<template>
  <svg t="1508738709248" class="screenfull-svg" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
    p-id="2069" xmlns:xlink="http://www.w3.org/1999/xlink" :width="`${width}px`" :height="`${height}px`" :fill="fill"
    @click="click">
    <path
...
export default {
  ...
  methods: {
    click () {
      ...
      screenfull.request(this.$parent.$el)
